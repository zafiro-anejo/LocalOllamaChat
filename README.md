...
**Сканированные PDF**: Docling поддерживает OCR через Tesseract; при включении соответствующей опции будет выполнен OCR с возможностью постобработки.
...
4. Поместите PDF-файлы, которые необходимо проиндексировать, в папку initial_files.
5. Запустите бэкенд:
```bash
